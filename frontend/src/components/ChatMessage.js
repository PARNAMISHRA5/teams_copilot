...
import FeedbackPopover from './FeedbackPopover'; // or correct relative path
...
<button
  ...
  className="p-1.5 rounded-md text-gray-400 hover:text-red-600 hover:bg-red-100 transition-all duration-200"
  title="Dislike"
>
